...
//!
//! The lab found the case this exists for: under a burst of cold activations,
//! 57 forwards died with `connect=true timeout=true` — TCP handshakes stalling
//! past the client's 3s connect timeout. Those never reached the owner, and
//! surfacing them to the caller was a self-inflicted error.
